...
public:
    void setupTestEnvironment() {
        ...
        config.json["securityChecks"].SetBool(false);
...
private:
    ...
    boost::filesystem::path prefixDir = boost::filesystem::absolute(
        sarus::common::makeUniquePathWithRandomSuffix("./sarus-test-prefixdir"));
