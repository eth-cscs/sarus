...
echo "source scl_source enable devtoolset-3" >> /root/.bashrc
echo "source scl_source enable devtoolset-3" >> /root/.profile
echo "source scl_source enable devtoolset-3" >> /home/docker/.bashrc
echo "source scl_source enable devtoolset-3" >> /home/docker/.profile
